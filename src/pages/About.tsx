          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 gap-20 items-center">
              ...
              <div className="space-y-12">
                <div>
                  <h3 className="text-minimal text-muted-foreground mb-6">OUR PRINCIPLES</h3>
                  <div className="space-y-6">
                    <div className="border-l-2 border-architectural pl-6">
                      <h4 className="text-lg font-medium mb-2">Ubiquitous Presence</h4>
                      <p className="text-muted-foreground">Endeavoring to cover the complete array of copper conductors across industries</p>
                    </div>
                    <div className="border-l-2 border-architectural pl-6">
                      <h4 className="text-lg font-medium mb-2">Certified Resilience</h4>
                      <p className="text-muted-foreground">Certifications that indicate resilience to survive business cycles</p>
                    </div>
                    <div className="border-l-2 border-architectural pl-6">
                      <h4 className="text-lg font-medium mb-2">Global Growth</h4>
                ...
                <div className="pt-8 border-t border-border">
                  <div className="grid grid-cols-2 gap-8">
                    ...
                    <div>
                      <h3 className="text-minimal text-muted-foreground mb-2">IN COPPER</h3>
